...
type Region = {
  id: number;
  code: string; // SA01..SA14
  name: string;
};

type Props = {
  regions: Region[];
  handleSearch: (regionId: number) => void;
  selectedRegionId?: number;
};

export default function SaudiMap({ regions, handleSearch, selectedRegionId }: Props) {
  const [activeRegionCode, setActiveRegionCode] = useState<string | null>(null);

  const getRegion = (code: string) => regions.find((r) => r.code === code);
  // console.log(getRegion('SA14')?.name);
  const handleClick = (code: string) => {
    setActiveRegionCode(code); // نخزن الكود اللي اتضغط
    const backendId = regionMap[code];
    if (backendId) {
      handleSearch(backendId); // نبعت الـ id للباك
    }
  };
  ...
  const regionMap: Record<string, number> = {
    ...
    SA06: 8, // حائل
    SA07: 7, // تبوك
    SA08: 9, // الحدود الشمالية
    SA09: 10, // جازان
    SA10: 11, // نجران
    SA11: 12, // الباحة
    SA12: 13, // الجوف
    SA13: 13, // شمال → mapped للجوف
    SA14: 6, // عسير
  };

  return (
    <div className="w-full flex justify-center items-center max-w-[700px]">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 700" className="w-auto h-[400px]">
        {/* الرياض SA01 */}
        <g>
          <path
            id="SA01"
            ...
            fill={selectedRegionId === regionMap['SA01'] ? '#07A869' : '#DFF6F0'}
            stroke="#15445A"
            strokeWidth="1"
            // onClick={() => {
            //   const r = getRegion('SA01');
            //   if (r) {
            //     const backendRegion = regionMap[r.code];
            //     if (backendRegion) {
            //       handleSearch(backendRegion.id);
            //     }
            //   }
            // }}
            // SaudiMap.tsx
            onClick={() => handleClick('SA01')}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          >
            <title>{getRegion('SA01')?.name}</title>
          </path>
          <text
            x={530.2}
            y={476.2}
        ...
        <g>
          <path
            ...
            fill={selectedRegionId === regionMap['SA02'] ? '#07A869' : '#DFF6F0'}
            stroke="#15445A"
            strokeWidth="1"
            // onClick={() => {
            //   const r = getRegion('SA02');
            //   if (r) {
            //     const backendRegion = regionMap[r.code];
            //     if (backendRegion) {
            //       handleSearch(backendRegion.id);
            ...
            //   }
            // }}
            onClick={() => handleClick('SA02')}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          >
            <title>{getRegion('SA02')?.name}</title>
          </path>
          <text
            x={351.3}
            y={534.7}
        ...
        <g>
          <path
            ...
            fill={selectedRegionId === regionMap['SA03'] ? '#07A869' : '#DFF6F0'}
            stroke="#15445A"
            strokeWidth="1"
            // onClick={() => {
            //   const r = getRegion('SA03');
            //   if (r) {
            //     const backendRegion = regionMap[r.code];
            //     if (backendRegion) {
            //       handleSearch(backendRegion.id);
            ...
            //   }
            // }}
            onClick={() => handleClick('SA03')}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          >
            <title>{getRegion('SA03')?.name}</title>
          </path>
          <text
            x={239.7}
            y={399}
        ...
        <g>
          <path
            ...
            fill={selectedRegionId === regionMap['SA04'] ? '#07A869' : '#DFF6F0'}
            stroke="#15445A"
            strokeWidth="1"
            // onClick={() => {
            //   const r = getRegion('SA04');
            //   if (r) {
            //     const backendRegion = regionMap[r.code];
            //     if (backendRegion) {
            //       handleSearch(backendRegion.id);
            ...
            //   }
            // }}
            onClick={() => handleClick('SA04')}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          >
            <title>{getRegion('SA04')?.name}</title>
          </path>
          <text
            x={733.3}
            y={548.4}
        ...
        <g>
          <path
            ...
            fill={selectedRegionId === regionMap['SA05'] ? '#07A869' : '#DFF6F0'}
            stroke="#15445A"
            strokeWidth="1"
            // onClick={() => {
            //   const r = getRegion('SA05');
            //   if (r) {
            //     const backendRegion = regionMap[r.code];
            //     if (backendRegion) {
            //       handleSearch(backendRegion.id);
            ...
            //   }
            // }}
            onClick={() => handleClick('SA05')}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          >
            <title>{getRegion('SA05')?.name}</title>
          </path>
          <text
            x={417.5}
            y={340.8}
        ...
        <g>
          <path
            ...
            fill={selectedRegionId === regionMap['SA06'] ? '#07A869' : '#DFF6F0'}
            stroke="#15445A"
            strokeWidth="1"
            onClick={() => handleClick('SA06')}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          >
            <title>{getRegion('SA06')?.name}</title>
          </path>
          <text
            x={347.2}
            y={268.7}
        ...
        <g>
          <path
            ...
            fill={selectedRegionId === regionMap['SA07'] ? '#07A869' : '#DFF6F0'}
            stroke="#15445A"
            strokeWidth="1"
            // onClick={() => {
            //   const r = getRegion('SA07');
            //   if (r) {
            //     const backendRegion = regionMap[r.code];
            //     if (backendRegion) {
            //       handleSearch(backendRegion.id);
            ...
            //   }
            // }}
            onClick={() => handleClick('SA07')}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          >
            <title>{getRegion('SA07')?.name}</title>
          </path>
          <text
            x={143}
            y={245.9}
        ...
        <g>
          <path
            ...
            fill={selectedRegionId === regionMap['SA08'] ? '#07A869' : '#DFF6F0'}
            stroke="#15445A"
            strokeWidth="1"
            // onClick={() => {
            //   const r = getRegion('SA08');
            //   if (r) {
            //     const backendRegion = regionMap[r.code];
            //     if (backendRegion) {
            //       handleSearch(backendRegion.id);
            ...
            //   }
            // }}
            onClick={() => handleClick('SA08')}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          >
            <title>{getRegion('SA08')?.name}</title>
          </path>
          <text
            x={397.2}
            y={166.1}
        ...
        <g>
          <path
            ...
            fill={selectedRegionId === regionMap['SA09'] ? '#07A869' : '#DFF6F0'}
            stroke="#15445A"
            strokeWidth="1"
            // onClick={() => {
            //   const r = getRegion('SA09');
            //   if (r) {
            //     const backendRegion = regionMap[r.code];
            //     if (backendRegion) {
            //       handleSearch(backendRegion.id);
            ...
            //   }
            // }}
            onClick={() => handleClick('SA09')}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          >
            <title>{getRegion('SA09')?.name}</title>
          </path>
          <text
            x={399.7}
            y={745}
        ...
        <g>
          <path
            ...
            fill={selectedRegionId === regionMap['SA10'] ? '#07A869' : '#DFF6F0'}
            stroke="#15445A"
            strokeWidth="1"
            // onClick={() => {
            //   const r = getRegion('SA10');
            //   if (r) {
            //     const backendRegion = regionMap[r.code];
            //     if (backendRegion) {
            //       handleSearch(backendRegion.id);
            ...
            //   }
            // }}
            onClick={() => handleClick('SA10')}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          >
            <title>{getRegion('SA10')?.name}</title>
          </path>
          <text
            x={531.3}
            y={699.4}
        ...
        <g>
          <path
            ...
            fill={selectedRegionId === regionMap['SA11'] ? '#07A869' : '#DFF6F0'}
            stroke="#15445A"
            strokeWidth="1"
            // onClick={() => {
            //   const r = getRegion('SA11');
            //   if (r) {
            //     const backendRegion = regionMap[r.code];
            //     if (backendRegion) {
            //       handleSearch(backendRegion.id);
            ...
            //   }
            // }}
            onClick={() => handleClick('SA11')}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          >
            <title>{getRegion('SA11')?.name}</title>
          </path>
          <text
            x={342.6}
            y={615.2}
        ...
        <g>
          <path
            ...
            fill={selectedRegionId === regionMap['SA12'] ? '#07A869' : '#DFF6F0'}
            stroke="#15445A"
            strokeWidth="1"
            // onClick={() => {
            //   const r = getRegion('SA12');
            //   if (r) {
            //     const backendRegion = regionMap[r.code];
            //     if (backendRegion) {
            //       handleSearch(backendRegion.id);
            ...
            //   }
            // }}
            onClick={() => handleClick('SA12')}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          >
            <title>{getRegion('SA12')?.name}</title>
          </path>
          <text
            x={227.6}
            y={166.7}
        ...
        <g>
          <path
            id="SA13"
            d="M192.8 56.2l-5.2 19.3-0.2 1.7 0.2 3.1 0.2 1.3 0.1 0.3 0.1 0.7 0.3 0.8 0.7 0.9 3.8 2.7 1.3 1.3 1.4 2 1.2 2.2 0.8 1.7 1.5 2.6 0.7 1 0.9 0.8 1 0.5 1 0.4 1.9 0.5 2.1 0.1 19.2-1.9 13.3-2 5.7 0.1 29.2 4.6 1.4 0.3 1 0.6 1 0.8 3.2 2.8 1.1 0.6 1.5 0.6 4 0.9 23.6 0.6 2.6-0.4 4.3 0 1.6 0.4 1.4 0.7 8.6 6.9 1.2 0.6 1.4 0.5 2.4 0.3 3.5 0 5.1 0.7 1.3 0.5 1.6 1 0.8 0.9 1.1 1.4 0.6 0.8 1.9 4.6 1.3 2.2 0.7 1.1 2.1 2 6.5 5 0.8 0.9 0.3 1-0.2 1-0.8 1-1.9 2-3.6 2.9-36 22.5-4.7 3.6-1.1 1.1-0.8 1-0.6 1-0.3 1.1-0.2 1-1.1 16.5-0.1 0.3-0.2 0.7-0.4 1-0.7 1-6.1 6.1-2.7-0.7-0.9 0.1-16.4 6.8-16 9.1-7.5 2.1-16.3 7.8-1.1 0.7-1 0.7-4.7 5.2-1.7-1.4-0.6-0.3-0.7-0.2-1.1-0.1-1.5 0.3-1.3 0.3-4.5 2.3-1.1 0.5-1 0.1-1.1-0.1-0.9-0.6-0.7-0.8-1.2-2.9-1.9 0-0.8-0.1-0.9-0.3-1.5-0.9-1-0.2-1.4 0.4-1.1 0.5-1.4 0.5-1.6 0.1-8.6-0.9-2.7-0.6-4.7-1.6-2-1.2-2.9-2.4-0.7-0.9-0.7-1-0.5-1-0.7-1.7-0.5-2.1-0.3-2.8-0.1-4.4 0.4-7.9-0.2-1.1-0.4-1-0.8-0.6-1-0.2-0.9 0.3-2.7 2.6-2.9 1.8-0.9 0.8-0.6 1-0.5 1-1.8 4.5-0.5 1-0.7 0.9-1 0.5-1.2 0.3-7.4-0.5-3.6-0.7-6.6-2.2-2.5-0.4-3.4 0-10.3 2.3-4.8 1.8-0.7 0-1 0-1.8-0.6-0.3-0.2-0.3-0.3-11.1-14.5-1.4-1.3-1.9-1.3-1-0.5-8.5-2.1-2.8 0-3.4 0.6-5.7 0.4-8.9 1.7-1.8 0.6-1.5 0.7-1.5 1.5-0.7 0.4-1.1 0.2-6.2-0.6-3.5-0.9-1.5-0.1-1.4 0.3-3.7 0.1 0-0.2-0.7-0.3 0-0.3 0.6-1.1 0.7-2 0.3-2.1-0.5-1.2 0-0.7 0.5-0.9 0.4-1.1 0.9-4.4 0.2-0.7 0.5-1.1-0.1-0.3 0.1-0.7 0.4-0.4 1-0.6-0.3-0.8-0.1-1.1 0.1-0.7 0.6 0.3 0-0.2 0-0.1 0.1-0.1 0.2 0-0.4-0.7-0.1-0.8 0.2-0.8 4.8 0.9 5.1 0.9 6.7 1.1 6 1.1 6.4 1.1 5.1 0.9 2.5 0.4 5 0.9 4.5 0.7 1.1 0 1.1-0.5 4.7-3.8 4.6-3.8 5-4.2 3.3-2.8 2.8-4.7 2.7-4.5 2-3.4 2.4-4.1 1-1.1 1.2-0.6 3.7-0.8 3.9-0.8 6.2-1.3 6.1-1.2 5.8-1.2 5.1-1.1 0.9-0.8 1.9-4.7 1.5-3.5 1.5-3.8 1.3-3.1 0.6-0.9 1-0.8 4.6-2.7 5.3-2.9 3.1-1.8 0.3-0.2 0.1 0-0.1 0-2.1-2.5-4.7-5.6-4.8-5.6-4.7-5.6-4.7-5.6-0.2-0.1-0.1-0.2-0.1-0.2-0.2-0.1-5.6-6.1-5.5-6-0.1-0.1-5.6-6.1-5.6-6.1 1.6-0.5 9.1-2.8 10.6-3.2 10.7-3.2 2.6-0.7 8.1-2.5 1.6-0.4z"
            fill={selectedRegionId === regionMap['SA13'] ? '#07A869' : '#DFF6F0'}
            stroke="#15445A"
            strokeWidth="1"
            // onClick={() => {
            //   const r = getRegion('SA13');
            //   if (r) {
            //     const backendRegion = regionMap[r.code];
            //     if (backendRegion) {
            //       handleSearch(backendRegion.id);
            ...
            //   }
            // }}
            onClick={() => handleClick('SA13')}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          >
            <title>{getRegion('SA13')?.name}</title>
          </path>
          <text
            x={227.6}
            y={166.7}
        ...
        <g>
          <path
            ...
            fill={selectedRegionId === regionMap['SA14'] ? '#07A869' : '#DFF6F0'}
            stroke="#15445A"
            strokeWidth="1"
            // onClick={() => {
            //   const r = getRegion('SA14');
            //   if (r) {
            //     const backendRegion = regionMap[r.code];
            //     if (backendRegion) {
            //       handleSearch(backendRegion.id);
            ...
            //   }
            // }}
            onClick={() => handleClick('SA14')}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          >
            <title className="!text-[#fff]">{getRegion('SA14')?.name}</title>
          </path>
          <text
            x={410.2}
            y={656.7}
