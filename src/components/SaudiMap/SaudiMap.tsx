...
export default function SaudiMap({ regions, handleSearch, selectedRegionId }: Props) {
  ...
  const backendId = regionMap[code]; // بيرجع رقم
  if (backendId) {
    handleSearch(backendId); // ✅ خلاص مفيش .id
  }
};
  ...
  return (
    <div className="w-full flex justify-center items-center max-w-[700px]">
      <svg
        ...
        viewBox="0 0 800 800"
        className="w-auto h-auto sm:h-[400px]"
      >
        {/* الرياض SA01 */}
        <g>
          <path
            ...
            stroke="#15445A"
            strokeWidth="1"
            className="region transition-colors duration-500 cursor-pointer"
            // onClick={() => {
